...
export const BlueskySettings = ({ userId }: BlueskySettingsProps) => {
  ...
  const handleToggle = () => {
    toggleMutation.mutate({ enabled: !isEnabled, userId })
  }
  ...
  return (
    <div className="flex flex-col gap-s">
      <Text>
        ...
        an{' '}
        <Link href="https://bsky.app/settings/app-passwords" variant="accent">
          App Password
        </Link>
        .
      </Text>
          ...
          {isConfigured && !showPassword ? (
            ...
            <Input
              ...
              {...register('appPassword', {
                required: isConfigured ? false : 'App Password is required',
              })}
              autoComplete="off"
            />
          )}

/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 62ae097a215880fc2cfc58b7b94dee0f)
// Runtime types generated with workerd@1.20260603.1 2026-03-12 nodejs_compat
interface __BaseEnv_Env {
	HYPERDRIVE: Hyperdrive;
	RATE_LIMITER: RateLimit;
	AI: Ai;
	ASSETS: Fetcher;
	OTTER_USER_API_KEY: string;
	CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE: string;
	BETTER_AUTH_SECRET: string;
	BETTER_AUTH_URL: string;
	BETTER_AUTH_TRUSTED_ORIGINS: string;
	VITE_ALLOW_SIGNUP: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OTTER_USER_API_KEY" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "BETTER_AUTH_TRUSTED_ORIGINS" | "VITE_ALLOW_SIGNUP" | "WEBHOOK_SECRET" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "STRIPE_PRICE_ID">> {}
}
